...
export const StepDiet = () => {
    ...
    const addAllergy = () => {
        if (allergyInput.trim()) {
            ...
            updateData({ allergies: [...currentAllergies, allergyInput.trim()] });
            setAllergyInput('');
        }
    };
    ...
    const removeAllergy = (index: number) => {
        const currentAllergies = data.allergies || [];
        updateData({ allergies: currentAllergies.filter((_, i) => i !== index) });
    };
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            onClick={addAllergy}
                            className="px-4 py-3 bg-primary-600 text-white rounded-xl font-medium hover:bg-black transition-all text-sm"
                        >
                            Ajouter
                        </button>
                    </div>
