...
import { ChevronLeft, ChevronRight, Apple, Target, Users, Zap, TrendingUp, Heart } from 'lucide-react';
            ...
            <div className="relative overflow-hidden rounded-3xl bg-white shadow-2xl">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-lg text-white/70 leading-relaxed">{currentScreen.description}</p>
                            </motion.div>
                ...
                <div className="absolute top-1/2 -translate-y-1/2 left-4 right-4 flex justify-between pointer-events-none">
                    <button
                        ...
                        className="pointer-events-auto w-12 h-12 rounded-full bg-white/80 hover:bg-white shadow-lg flex items-center justify-center transition-all hover:scale-110 text-gray-900"
