...
async function loadHealthPlugin(): Promise<any | null> {
    try {
        ...
        console.log('Plugin Health non installé (normal en mode web)');
        return null;
    }
}
...
export async function initHealthService(): Promise<{
    ...
    try {
        ...
        try {
            ...
            console.log('Capacitor non disponible');
            return { available: false, platform: 'none' };
        }
        ...
        if (platform === 'ios') {
            try {
                ...
                console.log('HealthKit non disponible:', e);
            }
            ...
            try {
                ...
                console.log('Google Fit non disponible:', e);
            }
        }
